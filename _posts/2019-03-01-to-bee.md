...
* Every time the player successfully pollinated a flower, they receive a bee fact delivered as a bark line, occassionally as a dialogue.
...
The script was finalised when the game was nearing the end stages of development. In future I would develop the narrative alongside the game, so I could embed mechanics 

and was originally planned to accompany a much larger game world. 

As a result when we scoped down the size of the game world, as well as removing some types of interactable objects, the script needed to be trimmed. 




I wrote two drafts of the script. The first had 43 voice lines, half of which formed a tutorial. The second draft trimmed the tutorial to 10 voice lines, and placed more emphasis on the bark lines to deliver the educational content.
