...
* Every time the player successfully completed an action - such as starting to fly or pollinating a flower - they trigger a bee fact delivered as a bark line, occassionally as a dialogue.
...
The script was written alongside the rest of the game development. It was important to keep a line of communication open with the team members working on the Unity prototype, to ensure that I wasn't writing content for features that were being changed or cut from the game. Similar it was important for the team to know where they had to build triggers for the dialogue lines.

In future I would design the narrative alongside the game mechanics. It would have been nice to have more story-driven mechanics in the game; in the end almost every line of dialogue was triggered in the same way and it was hard to avoid the sense that the story was tacked on at the last minute.
