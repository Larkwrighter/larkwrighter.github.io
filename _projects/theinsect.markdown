...
title: The Insect
year: 2019
description: A game about climate change, habitat renewal, and crawling on cadavers.
img: /img/theinsect.png
category: small game
datemade: November 2019
platform: PC
engine: Bitsy
---
...
<div class="row">
	<div class="col half left">
	    <img class="img-half" style="padding-bottom: 0px;" src="{{ site.baseurl }}/img/theinsectscreen3.png" alt="" title="The Insect Screenshot 1"/>
	</div>
	...
	<b>Date:</b> {{ page.datemade }}<br />
	<b>Platform:</b> {{ page.platform }}<br/>
	<b>Engine:</b> {{ page.engine }}<br />
